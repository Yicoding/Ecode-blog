...
INSERT INTO `loginfo` VALUES (1,'root',19,'123',1,4),(17,'伊泽',18,'123',3,2),(23,'admin-a',20,'123',2,1),(45,'架构师',20,'123',3,5);
...
CREATE TABLE `menu` (
  ...
  `descript` varchar(10000) DEFAULT NULL,
...
CREATE TABLE `menuimg` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `menu_id` int(11) DEFAULT NULL,
  `src` varchar(21000) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `ordermenu` VALUES (103,1,1),(104,2,1),(105,3,1),(106,3,2),(107,1,1),(108,2,1),(109,4,1),(110,6,1),(111,5,1),(112,1,2),(113,3,3),(114,5,1),(115,6,3),(116,6,1),(117,1,1),(118,2,2);
...
INSERT INTO `shop` VALUES (141,16,1,1,'false'),(142,16,2,1,'false');
...
-- Dump completed on 2017-12-12 11:05:59
